         ...
         <input
          ...
          @input="calculateResults()"/>
            ...
            <div class="container-two">
              <b-button pill variant="outline-success" @click="switchValues()">Cálcular</b-button>
              <h4 id="baseValue">01 {{ currency_one }}  com > {{ rate }} {{ currency_two }}</h4>
            </div>
